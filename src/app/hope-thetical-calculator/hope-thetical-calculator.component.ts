...
@Component({
  ...
  templateUrl: './hope-thetical-calculator.component.html',
  styleUrls: ['./hope-thetical-calculator.component.css'],
  providers: [DatePipe]

})
export class HopeTheticalCalculatorComponent implements OnInit {
